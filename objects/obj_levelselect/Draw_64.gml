...
fekles_draw_text(WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2 - 100  - scrollY, string_upper("Choose A Level"))
...
if load_quick(true, _checkpoint, "general_currentroom") != -4
{
	...
	fekles_draw_text(WINDOW_WIDTH / 1.4, WINDOW_HEIGHT - 50, "[C] DELETE CHECKPOINT DATA")
}
draw_set_color(c_white)